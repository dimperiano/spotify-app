    ...
    if (error) return (
        <div className='w-full h-screen flex justify-center items-center text-neutral-white-0 bg-neutral-black-10'>
            <div className='text-center max-w-3xl mx-auto'>
                ...
                <p>Esse app está no modo de desenvolvimento por isso o Spotify não permite que usuários que não estejam cadastrados no painel dessa aplicação acessem suas informações </p>
                <p>Você precisa solicitar permissão através do email <Link className='font-semibold text-neutral-white-0 hover:underline' target='__blank' href={mailtoHref}> imperiano.cn@gmail.com </Link>  informando o e-mail da sua conta do Spotify para cadastrarmos no painel do app manualmente. Para mais informações sobre as limitações do modo de desenvolvedor acesse a <Link className='font-semibold text-neutral-white-0 hover:underline' target='__blank' href={'https://developer.spotify.com/documentation/web-api/concepts/quota-modes'}> documentação do Spotify</Link>.</p>
            </div>
        </div>
    )

    return (
        <div className='bg-neutral-black-10 h-screen w-full flex items-center justify-center flex-col gap-6'>
